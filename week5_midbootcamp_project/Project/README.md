...
CUSTOMER:
* **Income level** (The lower the income level, the higher the acceptance of the offer) 
* **Credit rating** (The lower the credit rating, the higher the acceptance of the offer) 
...
* *Pre-processing*: Log Transformation, encoding with Dummies, MinMaxScaler 
